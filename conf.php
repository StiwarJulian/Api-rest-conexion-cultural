...
// * or when using nginx (autodetect fails)
 ...
 $app ="miguel_claros";
 $dominio = "https://conexioncultural.com.co";
 //$dominio = "http://localhost/credito";
 $dominio_server = "https://conexioncultural.com.co";
...
//$basename="concultu_wp493";
//$host="67.210.244.206";
//$userDatabase="concultu_wp493";
//$passDatabase="5Fp]8-S97w";

$basename="portalxn_concultu_wp493";
$host="192.185.128.14";
$userDatabase="portalxn_concult";
$passDatabase="5Fp]8-S97w";
...
//Todas las rutas definidas que terminan en _SERVER son para importar o incluir archivos de manera extar ,es decir que soporta rutas absolutas.como ejemplo archivos .js , .css , .jpg .ico .png etc.
 ...
 if (!defined('ROOT_PATH')) define('ROOT_PATH', $_SERVER['DOCUMENT_ROOT'].'/conexion_cultural/');
...
if (!defined('PRIVATE_SERVER')) define('PRIVATE_SERVER', RESOURCE_SERVER.'private/');
...
if (!defined('LOGIN_PATH')) define('LOGIN_PATH', MODULE_APP_SERVER.'');
